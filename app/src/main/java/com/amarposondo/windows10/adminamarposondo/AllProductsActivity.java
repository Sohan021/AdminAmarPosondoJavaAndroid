...
import com.amarposondo.windows10.adminamarposondo.Model.Products;
import com.amarposondo.windows10.adminamarposondo.ViewHolder.ProductViewHolder;
...
public class AllProductsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(AllProductsActivity.this, CartActivityUser.class);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, final int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setTitle("Have You Delete this Product ???");
